                  ...
                  child: ListTile(
                    subtitle: Column(
                      ...
                      children: [
                        ...
                        Text('Open Date: ${DateFormat('dd/MM/yyyy').format(DateTime.parse(IPOModel.opendate.trim()))}'),
                        Text('Close Date: ${DateFormat('dd/MM/yyyy').format(DateTime.parse(IPOModel.closedate.trim()))}'),
